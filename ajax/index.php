...
<body>
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center background">
            <div class="container">
                <h1 class="jumbotron-heading album">Album example</h1>
                    ...
                    <div class="row album-list">
                        <div class="col-md-4">
                            <div class="card mb-4 shadow-sm">
                                <img class="card-img-top" src="images/anh-hoa-sen-dep.jpg">
                                <div class="card-body">
                                    <p class="card-text word">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
